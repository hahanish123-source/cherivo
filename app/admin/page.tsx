                ...
                <tbody>
                  {filteredGreetings.map((g) => (
                    <tr key={g.token} style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.04)" }}>
                      <td style={{ padding: "14px 18px", fontWeight: 600 }}>{g.title}</td>
                      ...
                      <td style={{ padding: "14px 18px" }}>
                        <span style={{
                          ...
                          alignItems: "center",
                          gap: "4px",
                          background: g.responseCount > 0 ? "rgba(16, 185, 129, 0.15)" : "rgba(255, 255, 255, 0.05)",
                          color: g.responseCount > 0 ? "#10b981" : "rgba(255,255,255,0.4)",
                          padding: "3px 8px",
                          borderRadius: "6px",
                          fontWeight: 600
                        }}>
                          <MessageSquare size={12} /> {g.responseCount}
                        </span>
                      </td>
                  ...
                  {filteredGreetings.length === 0 && (
                    <tr>
                      <td colSpan={6} style={{ padding: "32px", textAlign: "center", color: "rgba(255,255,255,0.4)" }}>
                        No greetings found matching search.
                      </td>
                    </tr>
                  )}
                </tbody>
                ...
                <tbody>
                  {users.map((u) => (
                    <tr key={u.id} style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.04)" }}>
                      ...
                      <td style={{ padding: "14px 18px", color: "rgba(255,255,255,0.5)" }}>{new Date(u.created_at).toLocaleDateString()}</td>
                  ...
                  {users.length === 0 && (
                    <tr>
                      <td colSpan={5} style={{ padding: "32px", textAlign: "center", color: "rgba(255,255,255,0.4)" }}>
                        No registered users yet. Most cards are generated directly in local mode.
                      </td>
                    </tr>
                  )}
                </tbody>
            ...
            <div style={{ padding: "16px" }}>
              {allResponsesList.length === 0 ? (
                <div style={{ padding: "32px", textAlign: "center", color: "rgba(255,255,255,0.4)" }}>
                  No recipient responses have been sent yet.
                </div>
              ) : (
