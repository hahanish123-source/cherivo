...
export default function Home(){
  return <main className="siteShell landingPage">
    ...
    <footer className="siteFooter"><span>HANORA<span>•</span></span><small>Private moments, made carefully.</small><small>made with care · H</small></footer>
  </main>
}
