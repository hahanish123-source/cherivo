...
export default function CreatePage(){
  ...
  useEffect(()=>{
    ...
    try{
      ...
      if(x.audioName)setAudioName(x.audioName); if(x.audioUrl)setAudioUrl(x.audioUrl); if(x.backgroundVideo)setBackgroundVideo(x.backgroundVideo); if(x.backgroundVideoOpacity!==undefined)setBackgroundVideoOpacity(Number(x.backgroundVideoOpacity)); if(x.customBg)setCustomBg(x.customBg); if(x.customBgOpacity!==undefined)setCustomBgOpacity(Number(x.customBgOpacity)); if(x.customBgScale!==undefined)setCustomBgScale(Number(x.customBgScale)); if(x.customBgPositionX!==undefined)setCustomBgPositionX(Number(x.customBgPositionX)); if(x.customBgPositionY!==undefined)setCustomBgPositionY(Number(x.customBgPositionY));
