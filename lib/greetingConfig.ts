...
export function normalizeBlock(raw: any, fallbackIndex = 0, fallbackFont: FontName = "serif"): Block {
  ...
  return {
    ...
    titleColor: raw.titleColor !== undefined ? String(raw.titleColor) : (raw.kickerColor !== undefined ? String(raw.kickerColor) : undefined),
    kickerColor: raw.kickerColor !== undefined ? String(raw.kickerColor) : (raw.titleColor !== undefined ? String(raw.titleColor) : undefined),
    ...
    customBgFit: raw.customBgFit === "contain" || raw.customBgFit === "fill" ? raw.customBgFit : (raw.customBgFit ? "cover" : undefined),
    ...
    video: raw.video || raw.memoryVideo,
    videoName: raw.videoName ? String(raw.videoName) : "",
    videoOpacity: typeof raw.videoOpacity === "number" ? raw.videoOpacity : 100,
    videoScale: typeof raw.videoScale === "number" ? raw.videoScale : 100,
    videoPositionX: typeof raw.videoPositionX === "number" ? raw.videoPositionX : 50,
    videoPositionY: typeof raw.videoPositionY === "number" ? raw.videoPositionY : 50,
    videoFit: raw.videoFit === "contain" || raw.videoFit === "fill" ? raw.videoFit : "cover",
    videoRadius: typeof raw.videoRadius === "number" ? raw.videoRadius : 18,
    videoWidth: typeof raw.videoWidth === "number" ? raw.videoWidth : 100,
    videoAutoplay: Boolean(raw.videoAutoplay),
    videoMuted: raw.videoMuted !== false,
    videoLoop: Boolean(raw.videoLoop),
    ...
    textStyles: raw.textStyles && typeof raw.textStyles === "object" ? raw.textStyles : {},
    backButtonText: typeof raw.backButtonText === "string" ? raw.backButtonText : undefined,
    keepGoingButtonText: typeof raw.keepGoingButtonText === "string" ? raw.keepGoingButtonText : undefined,
    revealButtonText: typeof raw.revealButtonText === "string" ? raw.revealButtonText : undefined,
    replayButtonText: typeof raw.replayButtonText === "string" ? raw.replayButtonText : undefined,
...
export function normalizeProject(raw: any): GreetingProject {
  ...
  return {
    ...
    customBgFit: raw.customBgFit === "contain" || raw.customBgFit === "fill" ? raw.customBgFit : (raw.customBgFit ? "cover" : "cover"),
