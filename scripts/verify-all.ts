  ...
  blocks: [
    {
      ...
      cardColor: "#1e1025",
      cardOpacity: 35,
      customBg: "data:image/jpeg;base64,welcome-sec-bg",
      customBgName: "welcome-bg.jpg",
      customBgScale: 120,
      customBgPositionX: 55,
      customBgPositionY: 45,
      customBgRotation: 8,
      customBgOpacity: 85,
      backgroundOverlay: 22,
      imageOpacity: 95,
      visible: true,
...
async function runStorageFidelityTest() {
  ...
  const checks: [string, any, any][] = [
    ...
    ["Card Background Mode", data.cardBackgroundMode, "different"],
    ...
    ["Welcome Title Font", data.blocks[0].titleFont, "dancing-script"],
    ["Welcome Subtitle Font", data.blocks[0].subtitleFont, "great-vibes"],
    ["Welcome Body Font", data.blocks[0].bodyFont, "pacifico"],
    ["Welcome Title Size", data.blocks[0].titleSize, 15],
    ["Welcome Subtitle Size", data.blocks[0].subtitleSize, 16],
    ["Welcome Heading Size", data.blocks[0].headingSize, 85],
    ["Welcome Body Size", data.blocks[0].bodySize, 20],
    ["Welcome Emoji Size", data.blocks[0].emojiSize, 56],
    ["Welcome Custom BG", data.blocks[0].customBg, "data:image/jpeg;base64,welcome-sec-bg"],
    ["Welcome Custom BG Scale", data.blocks[0].customBgScale, 120],
    ["Welcome Custom BG Position X", data.blocks[0].customBgPositionX, 55],
    ["Welcome Custom BG Position Y", data.blocks[0].customBgPositionY, 45],
    ["Welcome Custom BG Rotation", data.blocks[0].customBgRotation, 8],
    ["Welcome Custom BG Opacity", data.blocks[0].customBgOpacity, 85],
    ["Welcome Background Overlay", data.blocks[0].backgroundOverlay, 22],
